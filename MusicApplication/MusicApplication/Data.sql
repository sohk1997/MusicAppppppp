...
go
insert into [Song](Name, URL, UploaderID, LastModified)	values(N'Em dạo này', 'abc', 38, '02-10-2017')
insert into [Song](Name, URL, UploaderID, LastModified)	values(N'Tôi muốn quên em', 'abc', 39, '02-10-2017')
insert into [Song](Name, URL, UploaderID, LastModified)	values(N'Em gái mưa', 'abc', 38, '02-10-2017')
insert into [Song](Name, URL, UploaderID, LastModified)	values(N'Túy âm', 'abc', 42, '02-10-2017')
insert into [Song](Name, URL, UploaderID, LastModified)	values(N'Chiều hôm ấy', 'abc', 43, '02-10-2017')
insert into [Song](Name, URL, UploaderID, LastModified)	values(N'Sao chẳng thể vì em', 'abc', 44, '02-10-2017')
insert into [Song](Name, URL, UploaderID, LastModified)	values(N'Xin gọi nhau là cố nhân', 'abc', 44, '02-10-2017')
insert into [Song](Name, URL, UploaderID, LastModified)	values(N'Chuyến tàu hoàng hôn', 'abc', 44, '02-10-2017')
insert into [Song](Name, URL, UploaderID, LastModified)	values(N'Trả lại thời gian', 'abc', 44, '02-10-2017')
insert into [Song](Name, URL, UploaderID, LastModified)	values(N'Nghẹn ngào', 'abc', 44, '02-10-2017')
insert into [Song](Name, URL, UploaderID, LastModified)	values(N'Người ta nói', 'abc', 39, '02-10-2017')
insert into [Song](Name, URL, UploaderID, LastModified)	values(N'Trộm nhìn nhau', 'abc', 44, '02-10-2017')
insert into [Song](Name, URL, UploaderID, LastModified)	values(N'Thành phố buồn', 'abc', 44, '02-10-2017')
insert into [Song](Name, URL, UploaderID, LastModified)	values(N'Sao chưa thấy hồi âm', 'abc', 39, '02-10-2017')
insert into [Song](Name, URL, UploaderID, LastModified)	values(N'Huyền thoại chiều mưa', 'abc', 39, '02-10-2017')
insert into [Song](Name, URL, UploaderID, LastModified)	values(N'Thương Tình Nhân', 'abc', 44, '02-10-2017')
insert into [Song](Name, URL, UploaderID, LastModified)	values(N'Con Đường Xưa Em Đi', 'abc', 44, '02-10-2017')
insert into [Song](Name, URL, UploaderID, LastModified)	values(N'Khi Đã Yêu', 'abc', 39, '02-10-2017')
insert into [Song](Name, URL, UploaderID, LastModified)	values(N'Xóa Sạch Hết', 'abc', 39, '02-10-2017')
go
